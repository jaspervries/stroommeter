...
function updateChart() {
    ...
    //get chart data
    $.getJSON('chart.php', { type: type, date: selectedDate.format('YYYY-MM-DD'), date2: selectedDate2.format('YYYY-MM-DD'), counter: (type == 8) ? custom : counter })
    .done(function(data) {
