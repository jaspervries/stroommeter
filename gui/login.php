...
if (!empty($_POST)) {
    ...
    if (array_key_exists($_POST['username'], $users) && password_verify($_POST['password'], $users[$_POST['username']])) {
        //set session
        session_start();
...
<?php
if ($loginerror == true) {
    echo '<p>Gebruikersnaam/wachtwoord combinatie incorrect</p>';
}
?>
<form method="POST">
